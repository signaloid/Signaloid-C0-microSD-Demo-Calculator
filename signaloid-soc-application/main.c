...
main(void)
{
	...
	generatedDistribution = UxHwFloatDistFromWeightedSamples(weightedSamples, kWeightedSampleCount);
		...
		*mmioSoCControl = 0xffffffff;
		...
		{	
			...
			case kCalculateDivision:
				 ...
				 *	Parse inputs
				 */
				argument1 = UxHwFloatUniformDist(MOSIBuffer[0], MOSIBuffer[1]);
				argument2 = UxHwFloatUniformDist(MOSIBuffer[2], MOSIBuffer[3]);
