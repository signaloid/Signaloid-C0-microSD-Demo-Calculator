...
run-all: $(VENV_DIR)
	...
	$(SELECTED_RUN_CMD) add "2.0(5)" "5.0(3)"
	$(SELECTED_RUN_CMD) sub "2.0(5)" "5.0(3)"
	$(SELECTED_RUN_CMD) mul "2.0(5)" "5.0(3)"
	$(SELECTED_RUN_CMD) div "2.0(5)" "5.0(3)"
	$(SELECTED_RUN_CMD) sample --count 100
